function Form() {
  return (
    <div className="flex flex-col gap-8 px-6 lg:flex-row lg:mt-16 lg:gap-0">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <svg
                ...
                height="20"
                fill="currentColor"
                className="bi bi-linkedin hover:fill-[#888888]"
                viewBox="0 0 16 16"
              >
            ...
            >
              <svg
                ...
                height="20"
                fill="currentColor"
                className="bi bi-telegram hover:fill-[#888]"
                viewBox="0 0 16 16"
              >
            ...
            <a href="" target="_blank" rel="noopener noreferrer">
              <svg
                ...
                height="20"
                fill="currentColor"
                className="bi bi-github hover:text-[#888888]"
                viewBox="0 0 16 16"
              >
      ...
      <form className="grid grid-cols-2 gap-3 lg:w-full">
        <input
        ...
        <button
          ...
          className="bg-sky-300 transition duration-300 rounded-[5px] text-blue-600 py-[12px] col-span-2 border  hover:bg-transparent hover:text-blue-600 hover:border-blue-600 outline-none"
        >
          Submit
        </button>
      </form>
